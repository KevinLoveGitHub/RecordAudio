...
public class ContentDataLoadTask extends AsyncTask<Void, Void, Void> {
    ...
    private List<FileItem> getAllPhoto() {
        ...
        String[] projection = new String[]{MediaStore.Images.ImageColumns._ID, MediaStore.Images.ImageColumns.DATA, MediaStore.Images
                .ImageColumns.DISPLAY_NAME};


        //asc 按升序排列
        //    desc 按降序排列
        //projection 是定义返回的数据，selection 通常的sql 语句，例如  selection=MediaStore.Images.ImageColumns.MIME_TYPE+"=? " 那么 selectionArgs=new
        // String[]{"jpg"};
        Cursor cursor = mContentResolver.query(MediaStore.Images.Media.EXTERNAL_CONTENT_URI, projection, null, null, MediaStore.Images
        ...
        while (cursor.moveToNext()) {
            ...
            Log.e("ryze_music", imageId + " -- " + fileName + " -- " + filePath);
    ...
    private List<FileItem> getAllMusic() {
        ...
        Cursor cursor = mContentResolver.query(MediaStore.Audio.Media.EXTERNAL_CONTENT_URI, projection, null, null, MediaStore.Audio
        ...
        while (cursor.moveToNext()) {
            ...
            fileDuration = cursor.getLong(cursor.getColumnIndexOrThrow(MediaStore.Video.Media.DURATION));

            Log.e("ryze_music", fileId + " -- " + fileName + " -- " + filePath + " -- " + fileDuration);
    ...
    private List<FileItem> getAllVideo() {
        ...
        Cursor cursor = mContentResolver.query(MediaStore.Video.Media.EXTERNAL_CONTENT_URI, projection, null, null, MediaStore.Video
    ...
    private List<FileItem> getAllText() {
        ...
        String[] projection = new String[]{MediaStore.Files.FileColumns._ID, MediaStore.Files.FileColumns.DATA, MediaStore.Files
                .FileColumns.TITLE, MediaStore.Files.FileColumns.MIME_TYPE};
        ...
        String[] selectionArgs = new String[]{"text/plain", "application/msword", "application/pdf", "application/vnd.ms-powerpoint",
                "application/vnd.ms-excel"};

        Cursor cursor = mContentResolver.query(MediaStore.Files.getContentUri("external"), projection, selection, selectionArgs,
        ...
        while (cursor.moveToNext()) {
            ...
            Log.e("ryze_text", fileId + " -- " + fileName + " -- " + "--" + cursor.getString(cursor.getColumnIndex(MediaStore.Files
                    .FileColumns.MIME_TYPE)) + filePath);
